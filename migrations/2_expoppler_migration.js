...
module.exports = async (deployer, network, [defaultAccount]) => {
  ...
  ExPoppler.setProvider(deployer.provider);

  if (network.startsWith("rinkeby")) {
    await deployer.deploy(ExPoppler, RINKEBY_VRF_COORDINATOR, RINKEBY_LINKTOKEN, RINKEBY_KEYHASH);
    let exp = await ExPoppler.deployed();
